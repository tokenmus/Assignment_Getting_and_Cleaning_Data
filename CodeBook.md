...
angle(tBodyAccJerkMean),gravityMean)		Average value of angle(tBodyAccJerkMean),gravityMean) for this subject while doing this
activity
...
angle(tBodyGyroJerkMean,gravityMean)		Average value of angle(tBodyGyroJerkMean,gravityMean) for this subject while doing this
activity
